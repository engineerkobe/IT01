package com.example.miku.myapplication.Book_Listview.adapter;
...
import com.example.miku.myapplication.R;
import com.example.miku.myapplication.bean.Book;
import com.example.miku.myapplication.view.MyImageView;
...
//			view = View.inflate(context, R.layout.activity_book__list_, null);//将一个布局文件转换成一个view对象
            ...
            //view = layoutInflater.inflate(R.layout.activity_book__list_, null);
        }
        //2.获取view上的子控件对象
